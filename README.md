...
To do so, go to the issues tab. After clicking on "New issue", select "New tutorial". Fill out the blanks, and submit the issue. It will usually take 6 hours for your issue to be viewed and another 30 mins for it to be approved or rejected. If it is approved, it will be added in the website with your username as credit. If it is rejected, it will be closed.If the issue is not seen, feel free to ping <a href="https://github.com/Genius398">@Genius398</a>.
